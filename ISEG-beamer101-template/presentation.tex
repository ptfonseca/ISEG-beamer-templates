...
\begin{frame}{The first frame}
	\begin{itemize}
		...
		\item In the next slides you will see some examples of what you can do with beamer.
...
% Bibliography frames (can be commented out)
%--------------------------------------------------------------
